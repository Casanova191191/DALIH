...
describe('Prueba login DALIH', () =>{
    it.only("Login DALIH", () =>{
        ...
        //Seleccion de proveedores desde el menú
        cy.get(':nth-child(1) > .sc-f24fa579-0 > :nth-child(2)').click()
        cy.wait(3000)
       
        //PROVEEDORES
        //boton agregar nuevo proveedores
        ...
        cy.get(':nth-child(31) > .ant-drawer > .ant-drawer-content-wrapper > .ant-drawer-content > .ant-drawer-wrapper-body > .ant-drawer-body > :nth-child(1) > [style="background: rgb(213, 255, 205);"] > .ant-row > :nth-child(3) > .ant-btn').should()
